...
\author{
	...
	\and
	\IEEEauthorblockN{Marco Crespi - 241177}
...
In this section, we detail how the BDI paradigm is instantiated for our pickup-and-delivery agent within the DeliverooJS game.
...
Intentions are the subset of desires that the agent commits to pursuing. Commitment is governed by a filtering function that considers the utility of each desire (including the ones coming from team's needs):
