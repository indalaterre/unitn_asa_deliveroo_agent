...
This may be due to being closer to a drop box or because the agent currently carrying the parcels is unable to reach it.
...
When an agent sends a handoff request, it calculates a meeting point to include in the request.
This is determined by finding the middle position between the agent making the handoff request and the agent receiving it.
