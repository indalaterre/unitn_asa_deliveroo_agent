...
export class CollaborativeIntentionFactory {
    ...
    static isHandoffIntention(intention: Intention): boolean {
        return intention?.context?.collaborativeType !== undefined &&
            (intention.context.collaborativeType === CollaborativeIntentionTypes.INITIATE_HANDOFF ||
             intention.context.collaborativeType === CollaborativeIntentionTypes.RECEIVE_HANDOFF ||
             intention.context.collaborativeType === CollaborativeIntentionTypes.WAIT_FOR_HANDOFF ||
             intention.context.collaborativeType === CollaborativeIntentionTypes.COMPLETE_HANDOFF);
    }
